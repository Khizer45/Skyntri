  ...
  return (
    <div id="home" className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 text-[#0F172A] dark:text-slate-100 font-sans selection:bg-blue-600 selection:text-white">
      ...
      <main>
        ...
        {/* PROJECT BRIEF */}
        <section id="intro" className="px-6 md:px-12 lg:px-24 py-20 bg-white/50 dark:bg-slate-800/30 border-b border-slate-100 dark:border-slate-700">
        ...
        {/* SOLUTIONS - Added professional padding */}
        <section id="solutions" className="px-6 md:px-12 lg:px-24 py-24 bg-slate-50 dark:bg-slate-900">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-12 tracking-tight">What Skyntri Does</h2>
            <div className="grid gap-8 lg:grid-cols-3">
              <SolutionCard
                accent="from-blue-50 to-blue-25"
                icon={<BrainCircuit size={22} className="text-blue-600 dark:text-blue-400" />}
              ...
              <SolutionCard
                ...
                icon={<Search size={22} className="text-emerald-600 dark:text-emerald-400" />}
              ...
              <SolutionCard
                ...
                icon={<MessageSquare size={22} className="text-violet-600 dark:text-violet-400" />}
